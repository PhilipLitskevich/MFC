    ...
    (() => {
        ...
        const breakpointChecker = function() {
            if (breakpoint.matches === true) {
                if (aboutSwiper !== void 0) {
                    ...
                    document.querySelectorAll(".swiper-slide, .swiper-wrapper").forEach((elem => {
            ...
            if (targetElement.classList.contains("_watcher-view")) {
                ...
                counters.forEach((counter => {
                    ...
                    function updateCount() {
                        ...
                        if (count < target) {
                            if (target - count > 1e4) counter.innerHTML = count + 301; else if (target - count > 3e3) counter.innerHTML = count + 101; else if (target - count > 501) counter.innerHTML = count + 21; else if (target - count > 99) counter.innerHTML = count + 7; else if (target - count > 55) counter.innerHTML = count + 3; else counter.innerHTML = count + 1;
        ...
        if (!isMobile.any()) {
            ...
            section.addEventListener("mousemove", (event => {
                ...
                if (xRotationAngle < 0 && Math.abs(xRotationAngle) > maxXRotationAngle) xRotationAngle = -maxXRotationAngle; else if (xRotationAngle > 0 && Math.abs(xRotationAngle) > maxXRotationAngle) xRotationAngle = maxXRotationAngle;
                if (yRotationAngle < 0 && Math.abs(yRotationAngle) > maxYRotationAngle) yRotationAngle = -maxYRotationAngle; else if (yRotationAngle > 0 && Math.abs(yRotationAngle) > maxYRotationAngle) yRotationAngle = maxYRotationAngle;
